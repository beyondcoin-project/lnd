...
var estimateFeeCommand = cli.Command{
	Name:      "estimatefee",
	Category:  "On-chain",
	Usage:     "Get fee estimates for sending beyondcoin on-chain to multiple addresses.",
...
var sendCoinsCommand = cli.Command{
	Name:      "sendcoins",
	Category:  "On-chain",
	Usage:     "Send beyondcoin on-chain to an address.",
	ArgsUsage: "addr amt",
	Description: `
	Send amt coins in satoshis to the base58 or bech32 encoded beyondcoin address addr.
	...
	Flags: []cli.Flag{
		cli.StringFlag{
			Name: "addr",
			Usage: "the base58 or bech32 encoded beyondcoin address to send coins " +
				"to on-chain",
		},
		cli.BoolFlag{
			Name: "sweepall",
		...
		cli.Int64Flag{
			Name:  "amt",
			Usage: "the number of beyondcoin denominated in satoshis to send",
		},
		cli.Int64Flag{
			Name: "conf_target",
...
var sendManyCommand = cli.Command{
	Name:      "sendmany",
	Category:  "On-chain",
	Usage:     "Send beyondcoin on-chain to multiple addresses.",
