...
watchtower:
      ...
      --watchtower.towerdir=                                  Directory of the watchtower.db (default: $HOME/.lnd-bynd/data/watchtower)
...
configuration option. Note that a trailing `/beyondcoin/mainnet/watchtower.db`
...
watchtower database at `/path/to/towerdir/beyondcoin/mainnet/watchtower.db`.

On Linux, for example, the default watchtower database will be located at:

```
/$USER/.lnd-bynd/data/watchtower/beyondcoin/mainnet/watchtower.db
```
