...
[INF] CHBU: Updating backup file at test_lnd3/data/chain/beyondcoin/simnet/channel.backup
[INF] CHBU: Swapping old multi backup file from test_lnd3/data/chain/beyondcoin/simnet/temp-dont-use.backup to test_lnd3/data/chain/beyondcoin/simnet/channel.backup
...
[`dropwtxmgr`](https://github.com/beyondcoin-project/byndwallet/tree/byndsuite/cmd/dropwtxmgr).
It can be installed with the following command:
```
⛰  git clone https://github.com/beyondcoin-project/byndwallet/
⛰  cd byndwallet
⛰  make build-all
```
...
```
⛰  cp $HOME/.lnd-bynd/data/chain/beyondcoin-project/mainnet/wallet.db $HOME/wallet.db # Copy the existing databse just in case!
⛰  dropwtxmgr --db=$HOME/.lnd-bynd/data/chain/beyondcoin/mainnet/wallet.db
```
...
```
~/.lnd-bynd/data/chain/beyondcoin/mainnet/channel.backup
```
