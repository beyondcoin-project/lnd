...
func newChainControlFromConfig(cfg *config, chanDB *channeldb.DB,
	...
	case "beyondcoind", "litecoind":
		...
		if err := bitcoindConn.Start(); err != nil {
			return nil, fmt.Errorf("unable to connect to beyondcoind: "+
				"%v", err)
		}
		...
		if cfg.Bitcoin.Active && !cfg.Bitcoin.RegTest {
			ltndLog.Infof("Initializing beyondcoind backed fee estimator in "+
	...
	case "byndd", "ltcd":
		...
		if !cfg.Bitcoin.SimNet && !cfg.Litecoin.SimNet &&
			...
			ltndLog.Infof("Initializing byndd backed fee estimator")
...
var (
	...
	chainDNSSeeds = map[chainhash.Hash][][2]string{
		bitcoinMainnetGenesis: {
			{
				"lseed1.beyondcoin.io",
				"soa.lseed1.beyondcoin.io",
			},
			{
				"lseed2.beyondcoin.io",
				"soa.lseed2.beyondcoin.io",
			},
		},
		bitcoinTestnetGenesis: {
			{
				"testnet-lseed1.beyondcoin.io",
				"soa.testnet-lseed1.beyondcoin.io",
			},
		},
